...
export default function FrontPage({ pokemons, types }: FrontPageProps) {
  ...
  const [typeFilter, setTypeFilter] = useState(typeFilterInitValue);
  ...
  return (
    <>
      <Suspense fallback={<div>Loading...</div>}>
        <SearchParamsHandler setSearchValue={setSearchValue} setTypeFilter={setTypeFilter} typeFilter={typeFilter} searchValue={searchValue} />
      </Suspense>
