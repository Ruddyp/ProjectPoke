...
export default function PokemonCard({ pokemon, types }: PokemonCardProps) {
    ...
    return (
        <Card className={`w-[350px] h-[450px] xs:w-[400px] xs:h-[500px] relative sm:w-[500px] sm:h-[600px] border-0 outline outline-offset-0 outline-8 outline-[#ffe165] rounded-xl transition hover:scale-105`} style={pokemon.cardStyle}>
